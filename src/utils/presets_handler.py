...
import arguments
from models.loaders.loaders_and_params import loaders_samplers
...
def random_preset(state):
    ...
    for cat in params_and_values:
        ...
        if arguments.args.loader is not None:
...
def loader_contains(sampler):
    if sampler == 'dynamic_temperature' and 'dynatemp_low' in loaders_samplers[arguments.args.loader]:
        return True
    else:
        return sampler in loaders_samplers[arguments.args.loader]
